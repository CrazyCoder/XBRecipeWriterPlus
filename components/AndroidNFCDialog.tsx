...
export default function AndroidNFCDialog(props: {
    ...
    return (
        <Sheet
            ...
            snapPoints={[60, 100]} // Adjust heights as necessary
        >
            <Sheet.Overlay />
            <Sheet.Handle />
            <Sheet.Frame
            ...
            >
                <YStack space={16} ai="center">
                    <Spinner size="large">
                    </Spinner>
                    {props.progress !== undefined ?
                        <XStack key={props.progress} paddingHorizontal="$5" alignItems='center'>
                            <ProgressBar styleAttr="Horizontal" color="blue" indeterminate={false} progress={props.progress/100} style={{ width: '100%' }} />
